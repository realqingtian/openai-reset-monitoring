...
const zh: Record<string, string> = {
  ...
  rhythmNextTip: "按平均间隔从上次命中推算，仅供参考",
  rhythmNoForecast: "样本不足，暂不做预测",
  rhythmStateWait: "按节奏等待公告", rhythmStateOver: "已逾期 · 继续盯梢",
  rhythmCycle: "本轮周期", rhythmBeyond: "已超出平均间隔", rhythmTimes: "{{n}} 倍",
  rhythmCdWait: "距预计下次", rhythmCdOver: "已逾期", rhythmOverPast: "预计点 {{t}} 已过",
  rhythmEmpty: "暂无命中记录，出现命中后这里会统计重置节奏。",
  heatTip: "{{day}} · {{n}} 次命中", heatTipZero: "{{day}} · 无命中", heatLess: "少", heatMore: "多",
  heatLoading: "加载中…", heatNoDetail: "未能取到该日明细", ddClose: "收起",
  hitHistory: "历史命中", pollLog: "检查日志",
  pollLogTip: "每次自动检查都会记录在这里，最多展示最近 200 条，记录保留 30 天",
  langAutoMenu: "自动（跟随浏览器）", langAutoShort: "自动", langSwitch: "切换语言",
  secFeed: "最近 24 小时的帖子",
  ...
  loginDesc: "此操作需要管理员权限，请输入管理员账号和密码继续。",
