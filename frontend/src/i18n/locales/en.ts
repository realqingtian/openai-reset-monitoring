...
const en: Record<string, string> = {
  ...
  rhythmNextTip: "Extrapolated from the average interval; rough estimate only",
  rhythmNoForecast: "Not enough samples to forecast",
  rhythmStateWait: "On rhythm · standing by", rhythmStateOver: "Overdue · still watching",
  rhythmCycle: "Current cycle", rhythmBeyond: "Beyond avg interval", rhythmTimes: "{{n}}x",
  rhythmCdWait: "Next expected in", rhythmCdOver: "Overdue by", rhythmOverPast: "expected {{t}} has passed",
  ...
  heatLoading: "Loading…", heatNoDetail: "Detail unavailable for this day", ddClose: "Close",
