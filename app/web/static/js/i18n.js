...
const I18N = {
  zh: {
    ...
    toastNeedToken: "此操作需要访问令牌",
    authBtnTip: "访问令牌", authTitle: "管理员验证",
    authDesc: "此操作需要访问令牌（MONITOR_ACCESS_TOKEN）。保存后自动重试；留空保存则清除本地已保存的令牌。",
    authPlaceholder: "访问令牌", authCancel: "取消", authSave: "保存",
  ...
  en: {
    ...
    toastNeedToken: "This action requires the access token",
    authBtnTip: "Access token", authTitle: "Admin verification",
    authDesc: "This action requires the access token (MONITOR_ACCESS_TOKEN). Saving retries automatically; save empty to clear the stored token.",
    authPlaceholder: "Access token", authCancel: "Cancel", authSave: "Save",
