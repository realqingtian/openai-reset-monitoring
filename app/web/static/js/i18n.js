...
const I18N = {
  zh: {
    ...
    replyPill: "回复", hideReplies: "隐藏回复",
    hideRepliesTip: "只看主贴，收起回复：公告一般以主贴发出，回复多为互动",
    allRepliesHidden: "窗口内的帖子全是回复，已被隐藏。",
    viewOnX: "在 X 上查看",
  ...
  en: {
    ...
    replyPill: "Reply", hideReplies: "Hide replies",
    hideRepliesTip: "Show original posts only — announcements usually come as posts, replies are mostly chatter",
    allRepliesHidden: "Every post in the window is a reply and is hidden by this filter.",
    viewOnX: "View on X",
