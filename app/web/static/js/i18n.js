...
const I18N = {
  zh: {
    ...
    pollLogTip: "面板最多展示最近 200 条检查记录；数据库保留最近 30 天，更早记录请直接查询 monitor.db",
  ...
  en: {
    ...
    pollLogTip: "Shows at most the latest 200 check records; the database keeps 30 days — query monitor.db directly for older logs",
