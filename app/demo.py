...
def _sample_tweets(account="thsottiaux"):
    ...
    return [
        {"id": "demo-1001", "account": account, "source": "demo",
         ...
         "created_at": at(6)},
        {"id": "demo-1002", "account": account, "source": "demo",
         ...
         "created_at": at(2)},
        {"id": "demo-1003", "account": account, "source": "demo",
         ...
         "created_at": at(11)},
        {"id": "demo-1004", "account": account, "source": "demo",
         ...
         "created_at": at(20)},
        {"id": "demo-1005", "account": account, "source": "demo",
         ...
         "created_at": at(30)},  # 超出 24 小时窗口，用于验证窗口过滤
    ]
